...
(function ($, window, document, undefined) {
    ...
    $.expr[':'].uncached = function (obj) {
        // Ensure we are dealing with an `image` element with a valid `src` attribute.
        if (!$(obj).is('image[src!=""]')) {
            return false;
        }
    ...
    var popup = {
        ...
        isImage: function (el) {
            ...
            if ($('<image src="' + el.src + '">').is('image:uncached')) {
        ...
        updateImagesMarkup: function (src, title, counter) {
            ...
            var markup = '<div class="cbp-popup-lightbox-figure">' +
                '<image src="' + src + '" class="cbp-popup-lightbox-image" ' + t.dataActionImg + ' />' +
                '<div class="cbp-popup-lightbox-bottom">' +
                ((title) ? '<div class="cbp-popup-lightbox-title">' + title + '</div>' : '') +
                ((t.options.lightboxShowCounter) ? '<div class="cbp-popup-lightbox-counter">' + counter + '</div>' : '') +
                '</div>' +
        ...
        resizeImage: function () {
            ...
            var height = $(window).height(),
                img = $('.cbp-popup-content').find('image'),
        ...
        preloadNearbyImages: function () {
            ...
            for (var i = arr.length - 1; i >= 0; i--) {
                ...
                if (t.dataArray[arr[i]].type === 'isImage') {
                    ...
                    if ($('<image src="' + src + '">').is('image:uncached')) {

                        //$(image).on('load.pm error.pm', {src: src }, function (e) {});
    ...
    var pluginObject = {
        ...
        /**
         * Get info aboutCancer client browser
         */
